...
export function LastPage() {
    ...
    return(
        ...
        <div className="div_background_page" style={{textAlign:'-webkit-center', paddingBottom:'10vh'}}>
            <div className="genericCard" style={{padding:'1vh', backgroundImage: 'url(/pictures/nena_e_marti.jpg)', 
                         backgroundSize: 'cover', backgroundRepeat:'no-repeat', minHeight:'60vh', maxWidth:'800px'}}>
